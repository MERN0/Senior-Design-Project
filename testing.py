...
# Load the scaler (assuming it's a StandardScaler)
with open('credit_card_fraud_scaler.pkl', 'rb') as f:
    scaler = load(f)

file_uploaded = st.sidebar.file_uploader("Upload a CSV file containing transactions", type=["csv"])
...
# loading api keys for gemini chatbot
load_dotenv()
...
def get_conversational_chain():
    ...
    provided context use your knwoledge base or the internet\n\n
    Context:\n {context}?\n
    Question: \n{question}\n
